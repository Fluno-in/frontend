  ...
  return (
    <div className="py-16">
      <Container>
        ...
        >
          <h1 className="mb-6 font-bold text-slate-900">About Suzao</h1>
        ...
        <div className="grid gap-12 md:grid-cols-2">
          ...
          >
            ...
            <div className="space-y-4 text-slate-600">
              <p>
                Suzao was founded in 2025 with a simple but powerful vision: to bridge the gap between local businesses and the influential voices in their communities.
              </p>
              <p>
          ...
          >
            ...
            <div className="space-y-4 text-slate-600">
              <p>
                At Suzao, our mission is to democratize advertising for small and medium-sized businesses through hyperlocal influencer collaboration and campaign automation.
              </p>
              <p>
        ...
        >
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="mb-4 text-2xl font-semibold">Join the Suzao Community</h2>
            <p className="mb-6 text-primary-100">
              Whether you're a local business looking to grow your customer base or an influencer wanting to partner with brands you believe in, Suzao is built for you.
            </p>
